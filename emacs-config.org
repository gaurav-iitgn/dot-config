...
- Try predictive (https://www.dr-qubit.org/predictive.html) [compilation errors]
- Try company-fuzzy (https://github.com/jcs-elpa/company-fuzzy)
#+begin_src emacs-lisp :tangle yes
...
(defun company-sample-backend (command &optional arg &rest ignored)
  ...
  (cl-case command
    ...
    (cl-remove-if-not
       ...
       sample-completions))))
; above works with keywords having spaces
; but company-fuzzy does not work then
...
(use-package company-fuzzy
  ...
  (setq company-fuzzy-sorting-backend 'flx
        ...
        company-fuzzy--backends '(company-sample-backend)
        company-fuzzy-trigge-symbols '("." "->" "<" "\"" "@")))
#+end_src
