...
#+begin_src emacs-lisp :tangle no
  ...
  (setq gs-ledger-file (concat *gs-gscloud-d* "/ledger/data/journal.ledger"))
	(setq org-capture-templates
...
;(setenv "GOPATH" (concat *gs-gscloud-d* "/bin/go"))
...
(use-package deft
  ...
  :commands (deft)
  :config
  (setq deft-directory (concat *gs-gscloud-d* "/Notes")
...
;;(if (not (eq system-type 'windows-nt))
  ...
  (setq user-mail-address "nazeer.observer@gmail.com"
        user-full-name "Gaurav Srivastava")
  ;(setq user-mail-address "gauravs@iitgn.ac.in"
        ;user-full-name "Gaurav Srivastava")
  ...
  (setq notmuch-search-oldest-first nil
        notmuch-fcc-dirs "~/mail/Accountname/[Gmail].Sent Mail"
  ...
  (setq message-auto-save-directory "~/mail/Accountname/[Gmail].Drafts")
  (setq message-kill-buffer-on-exit t)

  ;; change the directory to store the sent mail
  (setq message-directory "~/mail/Accountname")
))
#+end_src
...
(set-register ?J (cons 'file (concat *gs-gscloud-d* "/ledger/data/journal.ledger")))
